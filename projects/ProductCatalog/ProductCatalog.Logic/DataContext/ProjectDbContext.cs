//@CodeCopy
using ProductCatalog.Common.Modules.Exceptions;
...
{
    /// <summary>
    /// Represents the database context for the ProductCatalog application.
    /// </summary>
    internal sealed partial class ProjectDbContext : DbContext, IContext
    {
        ...
        /// </summary>
        private static readonly string ConnectionString = "data source=ProductCatalog.db";
        #endregion fields
