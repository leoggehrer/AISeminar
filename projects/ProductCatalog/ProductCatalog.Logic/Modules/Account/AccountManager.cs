//@CodeCopy
#if ACCOUNT_ON
using ProductCatalog.Logic.Entities.Account;
using ProductCatalog.Logic.Modules.Exceptions;
using ProductCatalog.Logic.Modules.Security;
using System.Text;

namespace ProductCatalog.Logic.Modules.Account
{
    using PasswordRules = CommonModules.Security.PasswordRules;
    using Error = CommonModules.Exceptions.ErrorType;
    using System.Reflection;
    using ProductCatalog.Common.Modules.ThreadSafe;
