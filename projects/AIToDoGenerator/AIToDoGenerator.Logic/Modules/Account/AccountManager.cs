//@CodeCopy
#if ACCOUNT_ON
using AIToDoGenerator.Logic.Entities.Account;
using AIToDoGenerator.Logic.Modules.Exceptions;
using AIToDoGenerator.Logic.Modules.Security;
using System.Text;

namespace AIToDoGenerator.Logic.Modules.Account
{
    using PasswordRules = CommonModules.Security.PasswordRules;
    using Error = CommonModules.Exceptions.ErrorType;
    using System.Reflection;
    using AIToDoGenerator.Common.Modules.ThreadSafe;
