...
namespace AIToDoGenerator.Common.Extensions
{
    ...
    public static partial class StringExtensions
    {
        ...
        public static string ExtractBetween(this string source, string startText, string endText)
        {
            ...
            sIdx = sIdx != -1 ? sIdx + startText.Length : sIdx;
            eIdx = sIdx != -1 ? source.IndexOf(endText, sIdx + 1) - 1 : eIdx;
        ...
        /// <summary>
        /// Normalizes all line endings in the string to <see cref="Environment.NewLine"/>.
        /// </summary>
        /// <param name="source">The input string whose line endings will be normalized.</param>
        /// <returns>A string with all line endings replaced by <see cref="Environment.NewLine"/>.</returns>
        public static string NormalizeLineEndings(this string source)
        {
            // Replace all types of line endings (\r\n, \n, or \r) with Environment.NewLine
            // Important: Replace \r\n first to avoid double replacement when matching \n separately
