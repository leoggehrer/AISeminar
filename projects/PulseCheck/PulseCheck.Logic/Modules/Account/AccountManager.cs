//@CodeCopy
#if ACCOUNT_ON
using PulseCheck.Logic.Entities.Account;
using PulseCheck.Logic.Modules.Exceptions;
using PulseCheck.Logic.Modules.Security;
using System.Text;

namespace PulseCheck.Logic.Modules.Account
{
    using PasswordRules = CommonModules.Security.PasswordRules;
    using Error = CommonModules.Exceptions.ErrorType;
    using System.Reflection;
    using PulseCheck.Common.Modules.ThreadSafe;
