...
- [SETemplate – Vorlage für SE-Architektur-Projekte](#setemplate--vorlage-für-se-architektur-projekte)
  ...
  - [Technologie-Stack](#technologie-stack)
    - [Backend (.NET 10.0)](#backend-net-100)
...
|**SETemplate.AngularApp**|Diese Projekt beinhaltet die Vorlage für die Erstellung einer **Angular 21** Anwendung. Als Styling-Framework ist **Bootstrap 5.3** vorinstalliert. Die Internationalisierung erfolgt über **ngx-translate**. Die Komponenten verwenden eine **Standalone-Architektur** (standalone: true).| Host | --- |
