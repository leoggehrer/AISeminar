...
| Typ | Pfad |
|-----|------|
| Stammdaten (Kategorien, Lookup) | `SETemplate.Logic/Entities/Data/EntityName.cs` |
| Anwendungsdaten (Geschäftslogik) | `SETemplate.Logic/Entities/App/EntityName.cs` |
...
public List<SETemplate.Logic.Entities.App.EntityName> EntityNames { get; set; } = [];
...
public SETemplate.Logic.Entities.App.EntityA? A { get; set; }

public IdType BId { get; set; }
public SETemplate.Logic.Entities.App.EntityB? B { get; set; }
```
