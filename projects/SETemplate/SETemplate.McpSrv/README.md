# SETemplate.McpSrv - Model Context Protocol Server

Ein **Model Context Protocol (MCP) Server** für das SETemplate-Projekt, der AI-Assistenten direkten Zugriff auf Backend-Funktionen ermöglicht.
...
```bash
# Server starten
dotnet run --project SETemplate.McpSrv
...
```bash
# SETemplate.Logic referenzieren
dotnet add reference ../SETemplate.Logic/SETemplate.Logic.csproj
```
...
namespace SETemplate.McpSrv.Servers;
...
```csharp
namespace SETemplate.McpSrv.Models;
...
- **SETemplate.Logic** - Backend-Logik und Datenzugriff
...
- [SETemplate Hauptdokumentation](../README.md)
